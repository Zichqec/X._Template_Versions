...
This template is created with the intention of being a code framework for you to fill in with your own character. As such, the character design and artwork of X. Template (the skeleton) are not free to use and must be replaced.

The dialogue is considered to be generic, and you are not required to replace it all. But please don't try to make a character out of the generic template dialogue, that would be uncomfortable.

Any code in this template is free to take and study and use in your own ghosts. All I ask is that if I have credited a name next to that code, that you also keep that credit.
